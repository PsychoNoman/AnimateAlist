...
//     .then((res) => res.json())
//     .then((data) => {
//       ani_result.innerHTML = `<img src=${data.file} alt="" />`;
//     });
// }
...
// getRandomAnime().then(({ title_english, images }) => {
//   const title1 = title_english;
//   const imageURL = images.jpeg.image_url; // a jpeg image
// });
